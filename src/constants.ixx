...
export {
    bool accIsPublic(int access_flags) { return (access_flags & JVM_ACC_PUBLIC) != 0; }
    bool accIsPrivate(int access_flags) { return (access_flags & JVM_ACC_PRIVATE) != 0; }
    bool accIsProtected(int access_flags) { return (access_flags & JVM_ACC_PROTECTED) != 0; }
    bool accIsStatic(int access_flags) { return (access_flags & JVM_ACC_STATIC) != 0; }
    bool accIsFinal(int access_flags) { return (access_flags & JVM_ACC_FINAL) != 0; }
    bool accIsSuper(int access_flags) { return (access_flags & JVM_ACC_SUPER) != 0; }
    bool accIsSynchronized(int access_flags) { return (access_flags & JVM_ACC_SYNCHRONIZED) != 0; }
    bool accIsVolatile(int access_flags) { return (access_flags & JVM_ACC_VOLATILE) != 0; }
    bool accIsBridge(int access_flags) { return (access_flags & JVM_ACC_BRIDGE) != 0; }
    bool accIsTransient(int access_flags) { return (access_flags & JVM_ACC_TRANSIENT) != 0; }
    bool accIsVarargs(int access_flags) { return (access_flags & JVM_ACC_VARARGS) != 0; }
    bool accIsNative(int access_flags) { return (access_flags & JVM_ACC_NATIVE) != 0; }
    bool accIsInterface(int access_flags) { return (access_flags & JVM_ACC_INTERFACE) != 0; }
    bool accIsAbstract(int access_flags) { return (access_flags & JVM_ACC_ABSTRACT) != 0; }
    bool accIsStrict(int access_flags) { return (access_flags & JVM_ACC_STRICT) != 0; }
    bool accIsSynthetic(int access_flags) { return (access_flags & JVM_ACC_SYNTHETIC) != 0; }
    bool accIsAnnotation(int access_flags) { return (access_flags & JVM_ACC_ANNOTATION) != 0; }
    bool accIsEnum(int access_flags) { return (access_flags & JVM_ACC_ENUM) != 0; }
    bool accIsModule(int access_flags) { return (access_flags & JVM_ACC_MODULE) != 0; }
    bool accIsMandated(int access_flags) { return (access_flags & JVM_ACC_MANDATED) != 0; }
